      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-xl text-sm text-[var(--color-muted)]">
            ...
            <span className="text-[var(--color-brand)]">Arcium MPC</span> —
            quant logic stays private, on-chain performance is fully verifiable.
          </p>
        </div>
        <Link
          href="/app/launch"
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <h3 className="mt-1.5 truncate text-sm font-semibold tracking-tight">
                  {v.name}
                </h3>
            ...
            <div className="mt-4 grid grid-cols-4 gap-2">
              <div>
                ...
                <p className="mono mt-0.5 text-sm font-semibold">
                  {fmtUsdc(v.tvlUsdc)}
                </p>
              </div>
              <div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div>
            ...
            <p className="mt-1.5 text-xs leading-relaxed text-[var(--color-muted)]">
              Every vault is a Solana program PDA. No manager key can drain
              funds. Withdraw any time — the on-chain instruction bypasses the
              agent entirely.
            </p>
          </div>
          <div>
            ...
            <p className="mt-1.5 text-xs leading-relaxed text-[var(--color-muted)]">
              Signal computation runs inside the Arcium MXE cluster under
              threshold encryption. No single node — including the strategy
              author — sees the plaintext computation state.
            </p>
          </div>
          <div>
