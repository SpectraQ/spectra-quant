    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="mt-2 text-sm text-[var(--color-muted)]">
          Traditional DeFi vaults face a dilemma: publish the strategy (alpha
          leak) or hide it (investor trust gap). Arcium MPC solves both sides.
        </p>
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-relaxed text-[var(--color-muted)]">
              The signal is computed locally by the agent instead of being sent
              to the Arcium cluster. The on-chain trade flow is identical — only
              the privacy guarantee is bypassed. Restart with{" "}
