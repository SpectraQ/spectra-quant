...
const STATS = [
  ...
  {
    label: "Strategies Launched",
    value: "Coming Soon",
    accent: "var(--color-muted)",
  },
  {
    label: "MPC Computations",
    value: "Coming Soon",
    accent: "var(--color-muted)",
  },
];
    ...
    <div className="flex min-h-screen flex-col relative overflow-hidden">
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, #8b5cf6 0%, #6d28d9 50%, transparent 75%)",
          }}
        />
        <div
      ...
      <main className="relative z-10 flex-1">
        ...
        <section className="mx-auto max-w-6xl px-4 pb-16 pt-24 md:pt-40">
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-wrap items-center gap-2">
              {["Solana", "Arcium MPC", "Pyth Oracle", "Raydium CPMM"].map(
                (tag) => (
            ...
            <p className="mt-7 max-w-2xl text-lg leading-relaxed text-[var(--color-muted)] md:text-xl">
              Launch a non-custodial trading vault on Solana in minutes. Your
              strategy runs inside{" "}
              <span className="text-[var(--color-cyan)]">Arcium MPC</span> —
              investors see verified on-chain performance. Your alpha stays{" "}
          ...
          <div className="mx-auto max-w-6xl px-4">
            <div className="flex divide-x divide-[rgba(139,92,246,0.1)] overflow-x-auto">
              {STATS.map((s) => (
                <div
                  key={s.label}
                  className="flex min-w-[140px] flex-col items-center gap-0.5 px-8 py-5"
                >
                  <span
        ...
        <section className="mx-auto max-w-6xl px-4 py-24">
          <div className="mb-12 text-center">
            <p className="mono text-xs uppercase tracking-[0.25em] text-[var(--color-brand)]">
              Protocol
            </p>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              ...
              <p className="mt-2 text-sm leading-relaxed text-[var(--color-muted)]">
                Deploy your edge without giving it away. Arcium MPC ensures your
                strategy computation never touches plaintext outside the secure
                cluster.
              </p>
            ...
            >
              ...
              <p className="mt-2 text-sm leading-relaxed text-[var(--color-muted)]">
                Browse a curated marketplace of verified trading vaults. Every
                position is on-chain, every return is verifiable, every
              ...
              <ul className="mt-6 space-y-3">
                {[
                  ...
                  <li
                    ...
                    className="flex items-start gap-2.5 text-sm text-[var(--color-muted)]"
                  >
                    <span className="mt-0.5 shrink-0 text-[var(--color-cyan)]">
                      ✓
                    </span>
                    <span>{item}</span>
                  </li>
                ...
                >
                  ...
                  <div className="mt-5 grid grid-cols-3 gap-3">
                    <div>
                      ...
                      <p className="mono mt-1 text-sm font-semibold text-[var(--color-text)]">
                        {v.tvl}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="mono mt-1 text-sm font-semibold text-[var(--color-positive)]">
                        {v.sharpe}
                      </p>
                    </div>
                    <div>
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-5 leading-relaxed text-[var(--color-muted)]">
                Strategy logic is visible on-chain. The price window each tick
                consumes is threshold-encrypted to the Arcium MXE cluster —
                decrypted only inside the secure computation, never exposed to
                any single node or the agent.
              </p>
              <p className="mt-4 leading-relaxed text-[var(--color-muted)]">
                The signal lands on-chain as a single integer. Trade execution
                flows through Raydium CPMM. Every step is verifiable. No
                off-chain oracle holds both the data and the decision.
              </p>
            ...
            >
              ...
              >
                ...
                />
                <span className="ml-2 mono text-[10px] text-[var(--color-muted)]">
                  signal-pipeline.ts
                </span>
              </div>
              <code className="mono block whitespace-pre p-6 text-xs leading-[2.1]">
                ...
                <span style={{ color: "rgba(34,211,238,0.75)" }}>
                  {"encrypt(mxe.pubkey)\n"}
                </span>
                <span style={{ color: "var(--color-cyan)" }}>{"arcium"}</span>
                <span style={{ color: "var(--color-muted)" }}>
                  {"  .computeSignal(encryptedWindow)\n"}
                </span>
                <span style={{ color: "#7070a0" }}>{"   ↓  "}</span>
        ...
        >
          <div className="mx-auto max-w-6xl px-4 py-24 text-center">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg text-[var(--color-muted)]">
              Stop running alpha in spreadsheets. Deploy a production vault in
              minutes — non-custodial, MPC-private, on Solana.
            </p>
